...
const Login: React.FC = () => {
    return (<>
        <Navbar/>
        <section>
            <div className='grid md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 lg:p-32 md:p-24 md:py-32 sm:p-20 sm:gap-24  xs:px-[38.496px] xs:py-28 md:gap-4 xs:gap-[47px] place-items-center md:text-start sm:text-start lg:text-start xs:text-center'>
                <div className=' md:order-1 sm:order-1  xs:order-2 flex flex-col gap-24 xs:gap-[42px] sm:gap-10 '>
                    ...
                    Portfodia helps recruiters simplify the process of hiring!
                    </h1>
                   <div>
                ...
                <div className=' md:order-2  xs:order-1 md:pl-14'>
                    <div>
                        <Image
                            src={AboutHero}
                            height={1000}
        ...
        <section className='lg:p-20 md:p-16 sm:p-10  md:py-32 xs:py-[67.537px] xs:px-[38.496px] sm:py-28 text-center bg-[#FFF6D7] flex flex-col gap-24'>
            <div className='flex flex-col gap-10'>
                <h1 className='lg:test-[55px] md:text-[50px]  md:font-[900] sm:text-[50px] sm:font-[900]  leading-[74.25px] xs:text-[26px] xs:font-[900] xs:leading-normal '>Join Portfodia Today!</h1>
                <p className=' lg:text-[26px] lg:font-[500] md:text-[20px] sm:text-[20px] md:font-[400]'>
                Bring all your resume into one platform, add collaborators to projects.
                </p>
                
            </div>
            <div>
                <button className='md:w-[352px] lg:w-[353px] md:py-[32px] sm:w-[353px] sm:py-[32px] bg-[#010101] text-white  rounded-xl lg:text-[26.122px] md:text-[20px] font-[700]  sm:text-[20px] mt-20 xs:w-[168.87px] xs:text-[15px] xs:py-[15.308px] xs:px-[12.438px] xs:rounded-md'>
                Get Started Now!
                </button>
            </div>
        </section>
